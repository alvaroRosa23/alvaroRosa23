...
- **[The Living Garden Mobile](https://github.com/laurimans/Garden-Mobile):** Spin-off para dispositivos móviles. Desarrollo de un sistema de físicas que utiliza el hardware nativo del teléfono (giroscopio/acelerómetro) como mecánica principal.
